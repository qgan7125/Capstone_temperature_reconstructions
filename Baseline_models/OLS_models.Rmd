...
```{r}
result_low <- OLS(3, OLS_boot, data_low, D47~Temperature, 1000)
...
result_intermediate <- OLS(3, OLS_boot, data_intermediate, D47~Temperature, 1000)
...
```{r}
result_high <- OLS(3, OLS_boot, data_high, D47~Temperature, 1000)
...
```{r}
set.seed(3)
lm(D47~Temperature, data = data_low)
```

```{r}
lm(D47~Temperature, data = data_intermediate)
```
```{r}
lm(D47~Temperature, data = data_high)
```
