...
plot_high <- createPlot(data_high, 
           result_high, 
           "RLM model with the high error data", 
           "RLM model with the high error data. Red line as true coefficient. Yellow is RLM fitted coefficient")
